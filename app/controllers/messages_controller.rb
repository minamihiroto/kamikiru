class MessagesController < ApplicationController
    def create
        ...
        Notification.create(notification_user_id: current_user.id, notification_notification_type_id: 3, notification_maching_id: params[:message][:message_maching_id], notification_message_id: recive_notice_user.id)
